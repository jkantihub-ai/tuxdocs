...
const Layout: React.FC<LayoutProps> = ({ children, activeSection, onNavigate, onSearch }) => {
  ...
  const navItems = [
    ...
    { id: NavigationSection.Terminal, label: 'AI Terminal', icon: 'M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    { id: NavigationSection.Moderation, label: 'Moderation', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
        ...
        <div className="p-8">
          <div className="p-6 rounded-[2rem] bg-slate-900 text-white relative overflow-hidden group">
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-400 font-bold">Uptime 99.9%</span>
            </div>
          </div>
        </div>
      </aside>
          ...
          <div className="flex-1 max-w-3xl px-4 hidden sm:block">
            <div className="relative group">
              ...
              <input 
                ...
                placeholder="Ask Tux: 'best ways to secure ssh'..."
                className="w-full bg-slate-50 border border-slate-100 rounded-2xl pl-14 pr-20 py-4 text-sm font-medium focus:outline-none focus:ring-4 focus:ring-orange-500/10 focus:bg-white focus:border-orange-500/30 transition-all"
              />
          ...
          <div className="flex items-center gap-6">
             ...
             <div className="flex items-center gap-3 pl-6 border-l border-slate-100">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold mt-1">Sudo Admin</p>
                </div>
                <div className="w-10 h-10 rounded-2xl bg-orange-500 flex items-center justify-center text-white font-black text-sm shadow-lg shadow-orange-500/20">
                  TU
                </div>
             </div>
          </div>
            ...
            <nav className="space-y-4">
              {navItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-6 py-4 rounded-2xl font-bold transition-all ${activeSection === item.id ? 'bg-orange-500 text-white shadow-xl shadow-orange-500/30' : 'text-slate-500'}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon} /></svg>
                  {item.label}
                </button>
